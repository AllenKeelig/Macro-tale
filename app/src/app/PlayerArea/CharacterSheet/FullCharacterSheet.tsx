...
interface CharacterPageProps {
  initialCharacter?: FullCharacterSheet;
}

// Default character if none is passed
const defaultCharacter: FullCharacterSheet = {
  id: "hero1",
  name: "Aria",
  pronouns: "she/her",
  species: "Elf",
...
const FullCharacterPage: React.FC<CharacterPageProps> = ({
  initialCharacter = defaultCharacter,
}) => {
  const [character, setCharacter] = useState<FullCharacterSheet>(initialCharacter);
